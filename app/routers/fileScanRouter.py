...
import os
import uuid
from app.services.file_scanner import file_scan
...
@router.post("/scan", dependencies=[Depends(JWTBearer())], tags=["File Scan"])
async def upload_file(
    ...
    try:
        report = file_scan(original_file_name, new_file_name)
